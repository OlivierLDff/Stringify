#ifndef __STRINGIFY_VERSION_HPP__
#define __STRINGIFY_VERSION_HPP__
...
#define STRINGIFY_SINGLETON_IMPL(Class, name, Name) \
    public: \
        static Class & name () { \
            static Class ret; \
            return ret; \
...
{
    Q_OBJECT
    STRINGIFY_SINGLETON_IMPL(Version, version, Version);
